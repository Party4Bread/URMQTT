...
from urmqtt.mqtt.connack import CONNECTION_ACCEPTED
from urmqtt.mqtt.protocol.client_handler import ClientProtocolHandler
from urmqtt.adapters import (
    StreamReaderAdapter,
    StreamWriterAdapter,
    WebSocketsReader,
    WebSocketsWriter,
)
from urmqtt.plugins.manager import PluginManager, BaseContext
from urmqtt.mqtt.protocol.handler import ProtocolHandlerException
...
class MQTTClient:
    ...
    :param client_id: MQTT client ID to use when connecting to the broker. If none, it will generated randomly by :func:`urmqtt.utils.gen_client_id`
    ...
    def __init__(self, client_id=None, config=None):
        ...
        if client_id is not None:
            ...
            from urmqtt.utils import gen_client_id
        ...
        self.plugins_manager = PluginManager("urmqtt.client.plugins", context)
    ...
    async def connect(
        ...
        :raise: :class:`urmqtt.client.ConnectException` if connection fails
        """
    ...
    async def reconnect(self, cleansession=None):
        ...
        :return: `CONNACK <http://docs.oasis-open.org/mqtt/mqtt/v3.1.1/os/mqtt-v3.1.1-os.html#_Toc398718033>`_ return code
        :raise: :class:`urmqtt.client.ConnectException` if re-connection fails after max retries.
        """
    ...
    async def deliver_message(self, timeout=None):
        ...
        :return: instance of :class:`urmqtt.session.ApplicationMessage` containing received message information flow.
