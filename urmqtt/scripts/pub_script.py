...
"""
urmqtt_pub - MQTT 3.1.1 publisher

Usage:
    urmqtt_pub --version
    urmqtt_pub (-h | --help)
    urmqtt_pub --url BROKER_URL -t TOPIC (-f FILE | -l | -m MESSAGE | -n | -s) [-c CONFIG_FILE] [-i CLIENT_ID] [-q | --qos QOS] [-d] [-k KEEP_ALIVE] [--clean-session] [--ca-file CAFILE] [--ca-path CAPATH] [--ca-data CADATA] [ --will-topic WILL_TOPIC [--will-message WILL_MESSAGE] [--will-qos WILL_QOS] [--will-retain] ] [--extra-headers HEADER] [-r]
...
def _gen_client_id():
    ...
    return "urmqtt_pub/%d-%s" % (pid, hostname)
