...
from urmqtt.mqtt import packet_class
...
from urmqtt.adapters import ReaderAdapter, WriterAdapter
...
class ProtocolHandler:
    ...
    async def _handle_message_flow(self, app_message):
        ...
        if app_message.qos == QOS_0:
            ...
            raise urmqttException("Unexcepted QOS value '%d" % str(app_message.qos))
